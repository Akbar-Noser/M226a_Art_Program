...
import ch.noseryoung.processing.Canvas;
import ch.noseryoung.processing.DiamondGeneratorThread;
...
class DiamondGeneratorThreadTest {
    ...
    void setUp() {
        ...
        diamondGeneratorThread = new DiamondGeneratorThread(new ch.noseryoung.processing.Point(0, 0),
                colors.get(0).getRGB(), 5, colors);
        controller = new Controller();
        lengthX = ch.noseryoung.processing.Canvas.getCanvasX();
